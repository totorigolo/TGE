...
namespace EntityFactory {
    ...
    namespace {
        ...
        // Level
        LevelManager &mLevelManager(LevelManager::GetInstance());
    }
    ...
    void CreateRagdoll(const b2Vec2 &position, int layer) {
        ...
        bodies["11_armL1"]->CreateBox(b2Vec3(0.f, 0.f, 0.f) + position, td, mResourceManager.GetTexture("hero_armL1"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["11_armL2"] = new BasicBody(layer);
        bodies["11_armL2"]->CreateBox(b2Vec3(0.f, -0.2f, 0.f) + position, td, mResourceManager.GetTexture("hero_armL2"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["12_legL1"] = new BasicBody(layer);
        bodies["12_legL1"]->CreateBox(b2Vec3(0.f, -0.3f, 0.f) + position, td, mResourceManager.GetTexture("hero_legL1"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["12_legL2"] = new BasicBody(layer);
        bodies["12_legL2"]->CreateBox(b2Vec3(0.f, -0.6f, 0.f) + position, td, mResourceManager.GetTexture("hero_legL2"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["13_footL"] = new BasicBody(layer);
        bodies["13_footL"]->CreateBox(b2Vec3(0.05f, -0.75f, 0.f) + position, td,
                                      mResourceManager.GetTexture("hero_footL"), 1.f, 0.2f, 0.f, -1);

        // Cou
        bodies["20_neck"] = new BasicBody(layer);
        bodies["20_neck"]->CreateBox(b2Vec3(0.f, 0.25f, 0.f) + position, td, mResourceManager.GetTexture("hero_neck"),
                                     1.f, 0.2f, 0.f, -1);

        // Torse
        bodies["31_torso3"] = new BasicBody(layer);
        bodies["31_torso3"]->CreateBox(b2Vec3(0.f, -0.1f, 0.f) + position, td,
                                       mResourceManager.GetTexture("hero_torso3"), 1.f, 0.2f, 0.f, -1);
        bodies["32_torso2"] = new BasicBody(layer);
        bodies["32_torso2"]->CreateBox(b2Vec3(0.f, 0.f, 0.f) + position, td, mResourceManager.GetTexture("hero_torso2"),
                                       1.f, 0.2f, 0.f, -1);
        bodies["33_torso1"] = new BasicBody(layer);
        bodies["33_torso1"]->CreateBox(b2Vec3(0.f, 0.15f, 0.f) + position, td,
                                       mResourceManager.GetTexture("hero_torso1"), 1.f, 0.2f, 0.f, -1);

        // Tête
        bodies["40_head"] = new BasicBody(layer);
        bodies["40_head"]->CreateCircle(b2Vec3(0.f, 0.5f, 0.f) + position, td, mResourceManager.GetTexture("hero_head"),
                                        1.f, 0.5f, 0.f, -1);

        // Jambe, bras et pied droit
        bodies["51_legR1"] = new BasicBody(layer);
        bodies["51_legR1"]->CreateBox(b2Vec3(0.f, -0.3f, 0.f) + position, td, mResourceManager.GetTexture("hero_legR1"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["51_legR2"] = new BasicBody(layer);
        bodies["51_legR2"]->CreateBox(b2Vec3(0.f, -0.6f, 0.f) + position, td, mResourceManager.GetTexture("hero_legR2"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["52_armR1"] = new BasicBody(layer);
        bodies["52_armR1"]->CreateBox(b2Vec3(0.f, 0.f, 0.f) + position, td, mResourceManager.GetTexture("hero_armR1"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["52_armR2"] = new BasicBody(layer);
        bodies["52_armR2"]->CreateBox(b2Vec3(0.f, -0.2f, 0.f) + position, td, mResourceManager.GetTexture("hero_armR2"),
                                      1.f, 0.2f, 0.f, -1);
        bodies["53_footR"] = new BasicBody(layer);
        bodies["53_footR"]->CreateBox(b2Vec3(0.05f, -0.75f, 0.f) + position, td,
                                      mResourceManager.GetTexture("hero_footR"), 1.f, 0.2f, 0.f, -1);
        ...
        // Création des joints
        joints.push_back(
                new rj(rjd(bodies["40_head"]->GetBody(), bodies["33_torso1"]->GetBody(), b2Vec2(0.f, -0.15f), true,
                           -30.f, 50.f, false, 0.f, 0.004f)));
        joints.push_back(
                new wj(wjd(bodies["20_neck"]->GetBody(), bodies["33_torso1"]->GetBody(), b2Vec2(0.f, -0.05f), 0.f,
                           0.f)));

        joints.push_back(
                new rj(rjd(bodies["33_torso1"]->GetBody(), bodies["32_torso2"]->GetBody(), b2Vec2(0.f, -0.1f), true,
                           -10.f, 10.f, true, 0.f, 0.004f)));
        joints.push_back(
                new rj(rjd(bodies["32_torso2"]->GetBody(), bodies["31_torso3"]->GetBody(), b2Vec2(0.f, -0.1f), true,
                           -10.f, 10.f, true, 0.f, 0.004f)));

        joints.push_back(
                new rj(rjd(bodies["11_armL1"]->GetBody(), bodies["33_torso1"]->GetBody(), b2Vec2(0.f, 0.1f), true,
                           -180.f, 0.f, true, 0.f, 0.004f)));
        joints.push_back(
                new rj(rjd(bodies["52_armR1"]->GetBody(), bodies["33_torso1"]->GetBody(), b2Vec2(0.f, 0.1f), true,
                           -180.f, 0.f, true, 0.f, 0.004f)));

        joints.push_back(
                new rj(rjd(bodies["12_legL1"]->GetBody(), bodies["31_torso3"]->GetBody(), b2Vec2(0.f, 0.1f), true,
                           -110.f, 30.f, true, 0.f, 0.004f)));
        joints.push_back(
                new rj(rjd(bodies["51_legR1"]->GetBody(), bodies["31_torso3"]->GetBody(), b2Vec2(0.f, 0.1f), true,
                           -110.f, 30.f, true, 0.f, 0.004f)));

        joints.push_back(
                new rj(rjd(bodies["11_armL1"]->GetBody(), bodies["11_armL2"]->GetBody(), b2Vec2(0.f, -0.1f), true, 0.f,
                           150.f, true, 0.f, 0.004f)));
        joints.push_back(
                new rj(rjd(bodies["52_armR1"]->GetBody(), bodies["52_armR2"]->GetBody(), b2Vec2(0.f, -0.1f), true, 0.f,
                           150.f, true, 0.f, 0.004f)));

        joints.push_back(
                new rj(rjd(bodies["12_legL1"]->GetBody(), bodies["12_legL2"]->GetBody(), b2Vec2(0.f, -0.1f), true,
                           -90.f, 0.f, true, 0.f, 0.004f)));
        joints.push_back(
                new rj(rjd(bodies["51_legR1"]->GetBody(), bodies["51_legR2"]->GetBody(), b2Vec2(0.f, -0.1f), true,
                           -90.f, 0.f, true, 0.f, 0.004f)));

        joints.push_back(
                new rj(rjd(bodies["12_legL2"]->GetBody(), bodies["13_footL"]->GetBody(), b2Vec2(-0.035f, -0.15f), true,
                           -90.f, 0.f, true, 50.f, 0.03f)));
        joints.push_back(
                new rj(rjd(bodies["51_legR2"]->GetBody(), bodies["53_footR"]->GetBody(), b2Vec2(-0.035f, -0.15f), true,
                           -90.f, 0.f, true, 50.f, 0.03f)));
    ...
    void CreatePlayer(b2Vec2 pos, double age, double strengh, sf::Color color) {
        // Crée le Hum
        Player * p = new Player();
        p->Create(pos, age, strengh, color);
        mLevelManager.SetPlayer(p);
